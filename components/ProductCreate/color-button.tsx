...
export function ColorButton({ color, selected, onClick }: ColorButtonProps) {
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "group relative h-8 w-8 cursor-pointer overflow-visible rounded-full transition-colors duration-200 hover:z-[80] hover:scale-105 focus-visible:z-[80]",
        selected &&
